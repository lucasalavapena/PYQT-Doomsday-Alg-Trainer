...
class gameStat():
    ...
    def writeToCSV(self):
        ...
        row = [self.startTime_, self.dateAsked_, self.weekdayGuessed_, self.correctGuess_, round(self.timeTaken_, 3),
               self.FeedbackStatus_]
        ...
        if (os.path.isfile(csvFilename)):
            ...
            csvData = [["Start Time", "Date Asked", "Weekday Guessed [0-6]", "Guessed Correctly [T/F]", "Time [s]",
                        "Feedback Status"], row]
